...
<body>
    ...
    <nav class="navbar navbar-light bg-darker navbar-expand-md" >
         <a href="index.php" class="navbar__logo">Dental Clinic</a>
    ...
    <div class="hero">
        <div class="hero__content">
            <h1 class="animate-hero fw-bold">Dental Clinic</h1>
        </div>
    </div>
    ...
    <div id="team" class="team">
        ...
        <div class="team__wrapper">
            <div class="team__card animate-team fw-semibold">
                <img src="style/images/staff1.jpg" alt="Dr. Goni" class="team__img">
                <p>Dr. Goni</p>
            </div>
            <div class="team__card animate-team fw-semibold">
                <img src="style/images/staff2.jpg" alt="Dr. Gloria" class="team__img">
                <p>Dr. Gloria</p>
            </div>
            <div class="team__card animate-team fw-semibold">
                <img src="style/images/staff3.jpg" alt="Dr. Ardjan" class="team__img">
                <p>Dr. Ardjan</p>
            </div>
            <div class="team__card animate-team fw-semibold">
                <img src="style/images/staff4.jpg" alt="Dr. Manjola" class="team__img">
                <p>Dr. Manjola</p>
            </div>
        </div>
    </div>
    ...
    <footer class="footer">
        <div class="footer__container">
            <div class="footer__desc">
                <h1>Dental Clinic</h1>
                <p>Your trusted dental care in Siri Kodra street</p>
            </div>
